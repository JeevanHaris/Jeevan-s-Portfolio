...
export default function HeroSection() {
  return (
    <section className="relative h-screen w-full flex flex-col justify-between overflow-x-clip bg-[#0C0C0C]">
      ...
      <div className="flex-1 flex flex-col justify-center items-center w-full z-20 relative px-4 sm:px-6 md:px-10 overflow-hidden">
        <FadeIn delay={0.15} y={40} className="w-full text-center">
          <h1 className="hero-heading font-black uppercase tracking-tight leading-none whitespace-nowrap text-center w-full text-[clamp(1.5rem,6.4vw,8.2rem)] mt-6 sm:mt-4 md:-mt-5">
            Hi, i&apos;m Jeevan Haris
          </h1>
        </FadeIn>
      </div>
